      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-400">Confirm Account Deletion</p>
          </div>

          {status === 'confirming' && (
            <div className="space-y-6">
              <div className={`rounded-lg p-4 border-2 bg-red-50 border-red-200`}>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-2.5 px-4 border border-transparent rounded-lg text-sm font-semibold text-white bg-red-600 hover:bg-red-700 transition-colors"
                >
                  Yes, Delete My Account
                </button>
                <button
                  onClick={() => navigate('/login')}
                  className="w-full py-2.5 px-4 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
                >
                  Cancel
                </button>
              </div>
