        ...
        <div className="w-full max-w-md">
          <div className={`glass-card rounded-2xl p-8 ${isDarkMode ? 'bg-gray-900/90 border border-gray-800' : ''}`}>
            <div className="text-center mb-8">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-400'}`}>Resend verification OTP</p>
            </div>
            ...
            {status === 'success' ? (
              <div className="text-center space-y-4">
                ...
                <div>
                  <h3 className={`text-lg font-semibold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Email Sent!</h3>
                  <p className={`text-sm mb-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{message}</p>
                </div>
